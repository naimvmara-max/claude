	...
	public static function pages() {
		return array(
			...
			'faq' => array(
				...
				'content' => "\n<h2>" . __( 'What exactly am I buying?', 'research-commerce' ) . "</h2>\n\n<p>" . __( 'A characterized reference material supplied as a lyophilized powder in a sealed vial, for laboratory research use. It is not a drug, supplement, food or cosmetic, and it is not supplied for human or veterinary use.', 'research-commerce' ) . "</p>\n\n<h2>" . __( 'Can I see the certificate before ordering?', 'research-commerce' ) . "</h2>\n\n<p>" . __( 'Yes. Where a third-party report has been published against the lot in stock it is linked on the product page and retrievable through the COA lookup, including after that lot sells out. A listing without one says so on the page, and the certificate is available on request before you order.', 'research-commerce' ) . "</p>\n\n<h2>" . __( 'How is purity measured?', 'research-commerce' ) . "</h2>\n\n<p>" . __( 'Reverse-phase HPLC with UV detection establishes purity; ESI mass spectrometry confirms identity against the theoretical mass. The method and test date are recorded on the certificate.', 'research-commerce' ) . "</p>\n\n<h2>" . __( 'Do you give protocol advice?', 'research-commerce' ) . "</h2>\n\n<p>" . __( 'We answer questions about composition, analytical results, solubility in laboratory solvents, storage and shipping. We do not advise on experimental design, and we do not answer questions about administration to humans or animals.', 'research-commerce' ) . "</p>\n\n<h2>" . __( 'What payment methods are accepted?', 'research-commerce' ) . "</h2>\n\n<p>" . __( 'Card payment at checkout, and bank transfer or purchase order for approved institutional accounts. Contact us before ordering if your institution requires a formal quote first.', 'research-commerce' ) . "</p>\n\n<h2>" . __( 'How quickly do orders ship?', 'research-commerce' ) . "</h2>\n\n<p>" . __( 'Same business day for orders placed before 2:00 PM CT, otherwise the next business day. Tracking and the lot certificate are emailed at dispatch.', 'research-commerce' ) . "</p>\n\n<h2>" . __( 'What does shipping cost?', 'research-commerce' ) . "</h2>\n\n<p>" . __( 'Shipping is calculated at checkout from the delivery address, and it is free above the order value shown on the catalog and in your basket. Every parcel goes insulated and desiccated, with tracking.', 'research-commerce' ) . "</p>\n\n<h2>" . __( 'Do you ship internationally, and who handles customs?', 'research-commerce' ) . "</h2>\n\n<p>" . __( 'We ship to addresses where these materials may lawfully be received for laboratory research. Import rules are the purchaser&#8217;s responsibility: duties, taxes and any licence or institutional approval your jurisdiction requires are yours to arrange, and a parcel held or returned by customs is not a fault of the goods.', 'research-commerce' ) . "</p>\n\n<h2>" . __( 'What do I do with the vial when it arrives?', 'research-commerce' ) . "</h2>\n\n<p>" . __( 'Lyophilized material is stable in transit but should go to -20&nbsp;&deg;C, desiccated and in the dark, on arrival. Let a cold vial reach room temperature before opening so moisture does not condense into the powder. Storage, handling and solvent notes are on every product page.', 'research-commerce' ) . "</p>\n\n<h2>" . __( 'What if the lot is wrong or the parcel is damaged?', 'research-commerce' ) . "</h2>\n\n<p>" . __( 'A lot that does not match its certificate, or material damaged in transit, is replaced or refunded within 30 days of delivery. Send the lot number and a photograph of the vial and packaging and we will arrange it.', 'research-commerce' ) . "</p>\n",
			),
